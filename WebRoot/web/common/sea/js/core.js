! function(a) {
    var b = "1.0.1",
        ...
        k = [],
        l = "C:/Users/zg/Desktop/cj/js/",
        m = {
            sea: "sea",
            seaConfig: "sea-config",
            seaCombo: "seajs-combo",
            jquery: "jquery",
            tongji: "tongji",
            global: "global"
        },
    ...
    k.push("sea"), k.push("seaConfig"), k.push("seaCombo"), /jQuery/gi.test(j) && k.push("jquery"), 
		a.document.write('<script id="JS_core" charset="utf-8" src="./web/common/sea/js/sea.js"></script>'), 
		a.document.write('<script id="JS_core" charset="utf-8" src="./web/common/sea/js/sea-config.js"></script>'), 
		a.document.write('<script id="JS_core" charset="utf-8" src="./web/common/sea/js/seajs-combo.js"></script>'),
		a.document.write('<script id="JS_core" charset="utf-8" src="./web/common/sea/js/jquery.js"></script>'),
	g.scriptReady("JS_core"), n.ready(function() {
