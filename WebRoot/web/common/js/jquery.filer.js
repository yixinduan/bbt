					...
					_changeInput: function() {
						...
						if(!n.limit || (n.limit && n.limit >= 2)) {
							...
							s.attr("name")
								...
								//.slice(-2) != "[]" ? s.attr("name", s.attr("name") + "[]") : null; // up by zxf 16.01.08
						}
						f._bindInput();
						if(n.files) {
							f._append(false, {
						...
						_box: function(params) {
							...
							if(l.length < 1) {
								...
								l.on('click', n.templates._selectors.remove, function(e) {
									e.preventDefault();
									var $this = $(this);
									// alertMsg_confirm 中是不能直接得到触发删除方法所得到的值
									alertMsg_confirm(n.captions.removeConfirmation,function(){
										setheight();
...
//									}
							...
							excl_input = function(id) {
								...
								if(input.size() == 0) {
									input = $('<input type="hidden" name="jfiler-items-exclude-' + (n.excludeName ? n.excludeName : (s.attr("name")
										...
										//.slice(-2) != "[]" ? s.attr("name") : s.attr("name") // up by zxf 16.01.08
	...
	$.fn.filer.defaults = {
		...
		templates:/*null, */{
			...
			item: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-icon pull-left">{{fi-icon}}</div><div class="jFiler-item-info pull-left"><div class="jFiler-item-title" title="{{fi-name}}">{{fi-name | limitTo:30}}</div><div class="jFiler-item-others"><span>文件大小: {{fi-size2}}</span><span>文件类型: {{fi-extension}}</span><span class="jFiler-item-status">{{fi-progressBar}}</span></div><div class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
			itemAppend: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-icon pull-left">{{fi-icon}}</div><div class="jFiler-item-info pull-left"><div class="jFiler-item-title">{{fi-name | limitTo:35}}</div><div class="jFiler-item-others"><span>文件大小: {{fi-size2}}</span><span>文件类型: {{fi-extension}}</span><span class="jFiler-item-status"></span></div><div class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
		...
		captions: {
			...
			removeConfirmation: "确定要删除已选中的文件吗？",
			errors: {
