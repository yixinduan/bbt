...
(function($){
	...
	_eventProxy = function(event) {
		...
		} else if (tools.eqs(event.type, "contextzymd")) {
			treeEventType = "contextzymd";
		...
		switch (treeEventType) {
			...
			case "dblclick" :
				...
				break;
			case "contextzymd" :
				treeEventCallback = handler.onZTreeContextzymd;
				break;
		}
		var proxyResult = {
			stop: false,
	...
	event = {
		...
		bindTree: function(setting) {
			...
			o.bind('contextzymd', eventParam, event.proxy);
		},
		unbindTree: function(setting) {
			...
			.unbind('contextzymd', event.proxy);
		},
		doProxy: function(e) {
			var results = [];
	...
	handler = {
		...
		onZTreeContextzymd: function(event, node) {
			var setting = data.getSetting(event.data.treeId);
