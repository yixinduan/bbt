...
+function ($) {
  ...
  Dropdown.prototype.toggle = function (e) {
    ...
    if (!isActive) {
      if ('ontouchstart' in document.documentElement && !$parent.closest('.navbar-nav').length) {
        ...
        $('<div class="dropdown-backdrop"/>').insertAfter($(this)).on('click', clearZymds)
      }
  ...
  Dropdown.prototype.keydown = function (e) {
    ...
    var $items = $parent.find('[role="zymd"]' + desc + ', [role="listbox"]' + desc)
  ...
  $(document)
    .on('click.bs.dropdown.data-api', clearZymds)
    .on('click.bs.dropdown.data-api', '.dropdown form', function (e) { e.stopPropagation() })
    .on('click.bs.dropdown.data-api', toggle, Dropdown.prototype.toggle)
    .on('keydown.bs.dropdown.data-api', toggle + ', [role="zymd"], [role="listbox"]', Dropdown.prototype.keydown)
...
+function ($) {
  ...
  ScrollSpy.prototype.activate = function (target) {
    ...
    if (active.parent('.dropdown-zymd').length) {
      active = active
        .closest('li.dropdown')
        .addClass('active')
    }
...
+function ($) {
  ...
  Tab.prototype.show = function () {
    ...
    var $ul      = $this.closest('ul:not(.dropdown-zymd)')
  ...
  Tab.prototype.activate = function (element, container, callback) {
    ...
    function next() {
      ...
      if (element.parent('.dropdown-zymd')) {
...
(function($) {
    ...
    var html = function() {
        return {
            ...
            dropdown: '<span class="tt-dropdown-zymd"></span>',
    ...
    var Dropdown = function() {
        ...
        function Dropdown(o) {
            ...
            this.$zymd = $(o.zymd).on("click.tt", ".tt-suggestion", onSuggestionClick).on("mouseenter.tt", ".tt-suggestion", onSuggestionMouseEnter).on("mouseleave.tt", ".tt-suggestion", onSuggestionMouseLeave);
            _.each(this.datasets, function(dataset) {
                that.$zymd.append(dataset.getRoot());
        ...
        _.mixin(Dropdown.prototype, EventEmitter, {
            ...
            _show: function() {
                this.$zymd.css("display", "block");
            },
            _getSuggestions: function getSuggestions() {
                return this.$zymd.find(".tt-suggestion");
            },
            _getCursor: function getCursor() {
                return this.$zymd.find(".tt-cursor").first();
            },
            ...
            _ensureVisible: function ensureVisible($el) {
                var elTop, elBottom, zymdScrollTop, zymdHeight;
                elTop = $el.position().top;
                elBottom = elTop + $el.outerHeight(true);
                zymdScrollTop = this.$zymd.scrollTop();
                zymdHeight = this.$zymd.height() + parseInt(this.$zymd.css("paddingTop"), 10) + parseInt(this.$zymd.css("paddingBottom"), 10);
                if (elTop < 0) {
                    this.$zymd.scrollTop(zymdScrollTop + elTop);
                } else if (zymdHeight < elBottom) {
                    this.$zymd.scrollTop(zymdScrollTop + (elBottom - zymdHeight));
                }
            },
            ...
            setLanguageDirection: function setLanguageDirection(dir) {
                this.$zymd.css(dir === "ltr" ? css.ltr : css.rtl);
            },
    ...
    var Typeahead = function() {
        ...
        function Typeahead(o) {
            ...
            $zymd = this.$node.find(".tt-dropdown-zymd");
            $input = this.$node.find(".tt-input");
            $hint = this.$node.find(".tt-hint");
            $input.on("blur.tt", function($e) {
                var active, isActive, hasActive;
                active = document.activeElement;
                isActive = $zymd.is(active);
                hasActive = $zymd.has(active).length > 0;
            ...
            $zymd.on("mousedown.tt", function($e) {
                $e.preventDefault();
            });
