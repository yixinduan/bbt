  ...
  if (!String.prototype.trim) {
    (function() {
      ...
      $(".temp-setting").click(function()
      {
        ...
        $(".temp-font-subzymd-list li").click(function() {
      ...
      $(document).ready(function(){
        $(".temp-main-font-family-list").click(function(){
          $(".temp-font-subzymd-list").slideToggle("slow");
        });
        ...
        $('.temp-list').click(function() {
          ...
          $(document).find('#temp-zymd').text(litext);
      ...
      $(document).on('click','.temp-color-radio-btn',function(){
        ...
        $(".temp-popup-form-wrapper .temp-content-wrapper .temp-change-setting-wrap .temp-setting-wrapper .temp-font-family .temp-main-font-family-list .temp-font-zymd .temp-font-subzymd-list").css('background', color2);
        $(".temp-setting").css('border-color', color1);
        $(".temp-font-zymd").css('border-color', color1);
    ...
    function(){
      $(this).css("background-color", "");
        ...
        // hover
        $(".temp-popup-form-wrapper .temp-content-wrapper .temp-change-setting-wrap .temp-setting-wrapper .temp-font-family .temp-main-font-family-list .temp-font-zymd .temp-font-subzymd-list li").hover(function(){
