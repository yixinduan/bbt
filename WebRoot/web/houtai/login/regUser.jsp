...
function savecheck(){
	...
	if(name.trim()==""){
		$("input[name='user.name']").next().html("此项不能为空！");
		flag = false;
	}
	...
	if(phone.trim()==""){
		$("input[name='user.phone']").next().html("此项不能为空！");
		flag = false;
	}
...
<form id="submitForm" class="form-horizontal" action="rootSave.action" method="post">
	<input type="hidden" name="supplier.id" value="${user.id }">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
			   <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="text-decoration:none; color:#333333;">
				    <div style="width: 100%;">	
				    	<span class="panel-title" style="">注册信息</span>
			...
			<div id="collapseOne" class="panel-collapse collapse in">
				<div class="panel-body" style="padding: 15px 0px 0px 15px;margin-bottom:0px;">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"><span style="color: #ff0000;">* </span>用户名</label>
						<div class="col-sm-10">
							<input check="required" onblur="checkReg(this);" maxlength="32" type="text" name="user.name" class="textInput frequired" value=""/>
				    ...
				    <div class="form-group">
						...
						<div class="col-sm-10">
							<input check="required" onblur="checkReg(this);" maxlength="32" type="text" name="user.pwd" class="textInput frequired" value=""/>
							<span class="info"></span>
						</div>
				    </div>
				    
				    <div class="form-group">
						<label class="col-sm-2 control-label"><span style="color: #ff0000;">* </span>手机号</label>
						<div class="col-sm-10">
							<input check="required" onblur="checkReg(this);" maxlength="64" type="text" name="user.phone" class="textInput frequired" value=""/>
							<span class="info"></span>
						</div>
				    </div>
					...
					<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea onblur="checkReg(this);" maxlength="256" style="width:200px; height: 90px; line-height: 20px; font-size: 14px; padding-top: 3px;" name="supplier.descs"></textarea>
								<span class="info"></span>
							</div>
					</div>
		      </div>
			...
			<div class="panel-heading" style="background-color:#fff;">
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<button type="button" onclick="savecheck()" class="btnNew btn-size-1 btn-blue" ><i class="search-icon icon-save"></i>注册</button>
