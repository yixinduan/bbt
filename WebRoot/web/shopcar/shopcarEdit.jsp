...
<form id="submitForm" class="form-horizontal" action="shopcarSave.action" method="post" target="shopcarBox">
	<input type="hidden" name="shopcar.id" value="${shopcar.id }">
			...
			<div id="collapseOne" class="panel-collapse collapse in">
				<div class="panel-body" style="padding: 15px 0px 0px 15px;margin-bottom:0px;">
					<div class="form-group">
						<label class="col-sm-2 control-label"><span style="color: #ff0000;">* </span>参加用户</label>
						<div class="col-sm-10">
							<span>${shopcar.user.name }</span>
