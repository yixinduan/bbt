...
<head>
<title>原料集合(/IB/WebRoot/web/zymd/zymdList.jsp)</title>
	...
	<div id="divTable" align="center" style="height:95%">
		<div class="tool">
			<div id="searchDiv" style=" width: 100%; height: 32px;">
				...
				<a href="javascript: deleteEntityAll('${basePath }/zymdAllDel.action?ids=');" class="buttonNew btn-red" style="width: 46px;"><i class="button-icon icon-delete"></i>删除</a>
